...
export const GENERATED_WHATS_NEW_ENTRIES: readonly WhatsNewEntry[] = [
  ...
  },
  {
    version: '1.25.0',
    date: '2026-05-04',
    highlights: ['Tile-paint → block-wall coupling'],
  },
];
